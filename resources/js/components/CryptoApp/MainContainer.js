            ...
            <table className='crypto-app-body-table'>
              ...
              <tbody>
                <tr>
                  ...
                  <td className='crypto-app-body-table-top-row'>Bitcoin</td>
                  <td rowSpan={2} className='crypto-app-body-table-row-span-element mobile-fild-hide'>DATA</td>
                  <td rowSpan={2} className='crypto-app-body-table-row-span-element mobile-fild-hide'>DATA</td>
                  <td rowSpan={2} className='crypto-app-body-table-row-span-element crypto-app-hourly-change-rate'>0.73%</td>
                </tr>
                <tr>
                  <td className='crypto-app-body-table-bottom-row'>BTX</td>
                </tr>
              </tbody>
            </table>
          </section>
